...
export const bandiChickenFriedRice: Dish = {
  ...
  ingredients: [
    ...
    { id: 'red-chilli-powder', name: 'Red chilli powder', quantity: '1/2 tsp', category: 'spice', note: 'Adds deeper fried-rice heat' },
    { id: 'garam-masala', name: 'Garam masala', quantity: '1/2 tsp', category: 'spice', note: 'Use right at the end for aroma' },
    { id: 'pepper', name: 'Black pepper powder', quantity: '1/2 tsp', category: 'spice' },
    { id: 'oil', name: 'Sunflower oil', quantity: '3 tbsp', category: 'main', note: 'Can also use rice bran oil or groundnut oil' },
  ...
  miseEnPlace: [
    ...
    { id: 'marinate-chicken', label: 'Marinate chicken in soy + ginger-garlic + chilli powder + pepper for 10 min', done: false },
  ...
  cookingSteps: [
    {
      ...
      instruction: 'Heat 1 tbsp sunflower oil in a hot wok until smoking. Add the chilli-and-pepper marinated chicken in a single layer. Sear undisturbed for 1 minute, then toss until cooked through and lightly charred. Remove to a plate.',
      beginnerExplanation:
    ...
    },
    {
      ...
      instruction: 'Add the remaining oil. Toss in dried chillies, spring onion whites and ginger-garlic. Stir-fry 30 seconds. Add capsicum, red chilli powder, and a pinch of salt, then stir-fry 1 minute.',
      beginnerExplanation:
    ...
    },
    {
      ...
      instruction: 'Add cold rice and break up any clumps. Drizzle soy and chilli sauce. Toss high and fast for 2 minutes until everything is hot and well coated. Return chicken + egg, toss again. Finish with spring onion greens, garam masala, black pepper, and salt if needed.',
      beginnerExplanation:
