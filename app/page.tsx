    ...
    <AppShell showBottomNav={false}>
      ...
      <section className="mt-7 flex flex-col items-center gap-3 animate-fade-up">
        <Link href={ROUTES.home} className="inline-flex">
          <button
            type="button"
            className="inline-flex min-w-[214px] items-center justify-center gap-1.5 rounded-full gradient-cta px-6 py-3 text-[14px] font-medium text-white shadow-cta transition-transform active:scale-95"
          >
            <span>{t('cta.startCooking')}</span>
        ...
        <Link href={ROUTES.home} className="inline-flex">
          <button
            type="button"
            className="inline-flex min-w-[214px] items-center justify-center gap-1.5 rounded-full border border-border/70 bg-card px-6 py-3 text-[14px] font-medium text-foreground shadow-soft transition-transform hover:bg-surface-warm active:scale-95"
          >
  ...
  return (
    <div className="relative overflow-hidden rounded-[28px] border border-border shadow-card">
      ...
      <div className="border-t border-border bg-card px-5 py-3 text-center">
        ...
        <div className="mt-1 font-serif text-lg font-semibold text-foreground">{dishName}</div>
      </div>
    </div>
  );
}
