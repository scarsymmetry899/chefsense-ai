...
import { ArrowUpRight, Clock3, Soup, Sparkles, UtensilsCrossed } from 'lucide-react';
      ...
      <div className="mt-5 space-y-4">
        {dishes.map((dish) => (
          <Link
            ...
            className="block overflow-hidden rounded-[28px] border border-border bg-card shadow-soft transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg"
          >
            <div className="grid grid-cols-[128px_1fr] gap-0">
              ...
              <div className="flex min-h-[164px] flex-col justify-between px-4 py-4">
                <div>
                  <div className="flex items-start justify-between gap-3">
                    <div className="font-serif text-[28px] leading-[0.98] text-foreground">{dish.dishName}</div>
