...
const COPY = {
  ...
  hi: {
    ...
    scoreTitle: 'प्लेटिंग स्कोर',
    scoreSubtitle: 'रेटिंग केवल फाइनल प्लेट अपलोड होने के बाद दिखाई जाएगी।',
    suggestions: 'ChefSense के सुझाव',
    captionTone: 'कैप्शन का टोन',
    captionLanguage: 'कैप्शन की भाषा',
    finalRating: 'अंतिम रेटिंग',
    selfRating: 'आपकी खुद की रेटिंग',
    copy: 'कैप्शन कॉपी करें',
    share: 'शेयर करें',
    save: 'सेव करें',
    done: 'कुकिंग हो गई',
    next: 'आगे क्या कोशिश करें',
    overall: 'कुल',
  ...
  te: {
    ...
    scoreTitle: 'ప్లేటింగ్ స్కోర్',
    scoreSubtitle: 'ఫైనల్ ప్లేట్ అప్‌లోడ్ చేసిన తర్వాతే రేటింగ్ కనిపిస్తుంది.',
    suggestions: 'ChefSense సూచనలు',
    captionTone: 'క్యాప్షన్ టోన్',
    captionLanguage: 'క్యాప్షన్ భాష',
    finalRating: 'తుది రేటింగ్',
    selfRating: 'మీ స్వంత రేటింగ్',
    copy: 'క్యాప్షన్ కాపీ చేయండి',
    share: 'షేర్ చేయండి',
    save: 'సేవ్ చేయండి',
    done: 'వంట అయిపోయింది',
    next: 'తర్వాత ఏమి ప్రయత్నించాలి',
    overall: 'మొత్తం',
    presentation: 'ప్రెజెంటేషన్',
    garnish: 'గార్నిష్',
    cleanliness: 'పరిశుభ్రత',
    lighting: 'వెలుతురు',
    ...
    forceAccept: 'ఈ ఫోటోను అలాగే వాడండి',
